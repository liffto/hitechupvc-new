  ...
  return (
    <Layout settings={settings}>
      <div className="bg-primary py-8 text-center text-white">
        <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-center">Our Products</h1>
      </div>
          ...
          {categories.map((cat) => (
            ...
            >
              ...
              <div className="py-5 px-5">
                <h3 className="text-base md:text-lg font-extrabold text-black tracking-tight text-left line-clamp-1">{cat.name}</h3>
                {cat.description && (

            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
              <div className="flex gap-4 col-span-1 md:col-span-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-100 leading-relaxed font-semibold mb-3">527/c Thiruvalluvar Thottam, Karuvampalayam, Tirupur, Tamil Nadu, 641604.</p>
              ...
              <div className="flex gap-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-100 leading-relaxed font-semibold mb-2">527/c Thiruvalluvar Thottam, Karuvampalayam, Tirupur, Tamil Nadu, 641604.</p>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            {settings.poweredByLogo && (
              <div className="flex items-center gap-3">
                 <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest whitespace-nowrap">Powered By</span>
                 <img 
